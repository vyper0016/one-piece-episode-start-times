...
class OnePieceTimestamps(ctk.CTk):
    def __init__(self):
        ...
        def previous_episode():
            ...
            if episode < 1:
                episode = 1
                return
            self.update_labels(episode_entry, timestamp_label, comment_label, episode)
    ...
    def update_labels(self, episode_entry, timestamp_label, comment_label, episode:int):
